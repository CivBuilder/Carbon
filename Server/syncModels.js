...
sequelize.sync().then(result => {
    ...
    //return QuizModel.create({ quizid: "1", quizname:"quiz 1"})
    //return QuestionModel.create({quesid: "1", quizid: "1",question: "1. Is this the first question?"})
    return AnswerModel.create({ansid: "1", quesid: "1", answer: "Yes", iscorrect: "true"})
    console.log(result);
}).then(quizcontent => {
