...
//     expect(emailInput.props.value).toBe('testuser@test.com');
//     expect(passwordInput.props.value).toBe('testpassword');
//     expect(confirmPasswordInput.props.value).toBe('testpassword');
//   });

//   test('handles sign up button press correctly', () => {
//     const mockSignup = jest.fn();
//     const navigation = {
//       navigate: jest.fn(),
//     };

//     const { getByTestId } = render(<SignUpScreen navigation={navigation} signup={mockSignup} />);
