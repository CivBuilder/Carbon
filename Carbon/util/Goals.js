...
export const calculateGoalProgress = async () => {
    ...
    const previousMonthEmissions = await getPreviousMonthEmissions();
    // i need to get last calendar month emissions
    // i need to get this calendar month emissions and divide it by daysSoFarThisMonth
    ...
    const thisMonthGoalEmissions = factor * previousMonthEmissions;
    const goalProgress = ;
}